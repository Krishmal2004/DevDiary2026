...
- [VS Code Extension](./vscode-extension.md) — design and build plan for the VS Code extension: features, token sign-in, backend changes, publishing
